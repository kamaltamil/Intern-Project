...
describe("AppRoutes", () => {
  test("should render login page at /login", () => {
    renderWithProviders("/login");
    // The Card title renders the Title component with "Task Manager Login"
    expect(screen.getByText("Sign In")).toBeInTheDocument();
    expect(screen.getByText("Create an account")).toBeInTheDocument();
  });

  test("should render register page at /register", () => {
  ...
  test("should redirect / to /dashboard then to login", () => {
    renderWithProviders("/");
